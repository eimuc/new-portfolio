          ...
          if (!(a.params.threshold && Math.sqrt(Math.pow(u, 2) + Math.pow(h, 2)) < a.params.threshold)) {
            ...
            if (void 0 === i.isScrolling)
              (a.isHorizontal() && n.currentY === n.startY) || (a.isVertical() && n.currentX === n.startX)
                ? (i.isScrolling = !1)
                : u * u + h * h >= 25 &&
                  ((v = (180 * Math.atan2(Math.abs(h), Math.abs(u))) / Math.PI), (i.isScrolling = a.isHorizontal() ? v > s.touchAngle : 90 - v > s.touchAngle));
            if (
              ...
              if (
                ...
                f > 0 && i.currentTranslate > a.minTranslate()
                  ...
                  : f < 0 &&
                    ...
                    ((g = !1), s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - f, b))),
        ...
        if (i.freeModeMomentum) {
          ...
          if (w < t.maxTranslate())
            i.freeModeMomentumBounce
              ? (w + t.maxTranslate() < -C && (w = t.maxTranslate() - C), (y = t.maxTranslate()), (S = !0), (a.allowMomentumBounce = !0))
              : (w = t.maxTranslate()),
              i.loop && i.centeredSlides && (T = !0);
          else if (w > t.minTranslate())
            i.freeModeMomentumBounce
              ? (w - t.minTranslate() > C && (w = t.minTranslate() + C), (y = t.minTranslate()), (S = !0), (a.allowMomentumBounce = !0))
              : (w = t.minTranslate()),
              i.loop && i.centeredSlides && (T = !0);
        ...
        updateSlides: function () {
          ...
          if (void 0 !== r) {
              ...
              if (i.slidesPerColumn > 1) {
                ...
                if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                  ...
                  "column" === i.slidesPerColumnFill
                    ? ((N = I - (D = Math.floor(I / k)) * k), (D > $ || (D === $ && N === k - 1)) && (N += 1) >= k && ((N = 0), (D += 1)))
            ...
            if (
              ...
              n && o && ("slide" === i.effect || "coverflow" === i.effect) && s.css({ width: e.virtualSize + i.spaceBetween + "px" }),
              i.setWrapperSize)
            )
      ...
      images: {
        loadImage: function (e, t, a, i, s, r) {
          ...
          m(e).parent("picture")[0] || (e.complete && s)
            ? d()
            : t
            ? (((n = new l.Image()).onload = d), (n.onerror = d), i && (n.sizes = i), a && (n.srcset = a), t && (n.src = t))
            : d();
        },
          ...
          return (
            void 0 === i.params ||
              ...
              t &&
                ...
                o &&
                  o.length &&
                  o.removeClass([s.slideVisibleClass, s.slideActiveClass, s.slideNextClass, s.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")),
              i.emit("destroy"),
  ...
  var _ = {
      update: function (e) {
        ...
        (m = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top"),
          r ? ((g = Math.floor(i / 2) + s + l), (b = Math.floor(i / 2) + s + o)) : ((g = i + (s - 1) + l), (b = s + o));
  ...
  var K = {
      ...
      event: function () {
        return o().navigator.userAgent.indexOf("firefox") > -1
          ...
          : (function () {
              ...
              return (
                !a && e.implementation && e.implementation.hasFeature && !0 !== e.implementation.hasFeature("", "") && (a = e.implementation.hasFeature("Events.wheel", "3.0")), a
              );
            })()
          ? "wheel"
          : "mousewheel";
    ...
    Z = {
      ...
      init: function () {
        ...
        (i.nextEl || i.prevEl) &&
          (i.nextEl &&
            ((e = m(i.nextEl)), a.params.uniqueNavElements && "string" == typeof i.nextEl && e.length > 1 && 1 === a.$el.find(i.nextEl).length && (e = a.$el.find(i.nextEl))),
          i.prevEl &&
            ((t = m(i.prevEl)), a.params.uniqueNavElements && "string" == typeof i.prevEl && t.length > 1 && 1 === a.$el.find(i.prevEl).length && (t = a.$el.find(i.prevEl))),
    ...
    J = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            ("fraction" === a.type && (r.find(z(a.currentClass)).text(a.formatFractionCurrent(i + 1)), r.find(z(a.totalClass)).text(a.formatFractionTotal(n))),
            "progressbar" === a.type)
          ) {
            var E;
      ...
      setTranslate: function () {
        for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
          ...
          var n = -180 * r,
            ...
            d = 0;
          if (
            (e.isHorizontal() ? a && (n = -n) : ((d = l), (l = 0), (o = -n), (n = 0)), (s[0].style.zIndex = -Math.abs(Math.round(r)) + t.length), e.params.flipEffect.slideShadows)
          ) {
      ...
      init: function () {
        ...
        return (
          t.swiper instanceof a
            ...
            : S(t.swiper) &&
              ((e.thumbs.swiper = new a(C({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
